          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed">
                <p>
                  City Blessing Church is a Christ-centred community committed to knowing God, growing in faith, and sharing His love with our city. Whether you are new to church, exploring faith, or looking for a place to belong, we would love to have you.
                </p>
                <p>
              ...
              <Link
                ...
                className="inline-block mt-6 bg-secondary text-white px-8 py-3 font-semibold border-2 border-secondary hover:bg-transparent hover:text-secondary transition-colors rounded-full"
              >
                How to get there
              </Link>
            </div>
            ...
            <div className="relative rounded-xl overflow-hidden flex justify-center">
              ...
              <Image
                ...
                alt="Welcome to City Blessing Church"
                width={0}
                height={0}
                sizes="100vw"
